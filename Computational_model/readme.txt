mainHierarchNoiseSeq_beta_All_Final.m is the main file for generating the four figures in the paper: 
...
The remaining files are all supporting codes for mainHierarchNoiseSeq_betaAll.m.
